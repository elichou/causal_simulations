...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/apple/Downloads/bandit-game/online_task_lastrun.py',
...
text_5 = visual.TextStim(win=win, name='text_5',
    text='',
    font='Open Sans',
    pos=(0, -0.8), height=0.03, wrapWidth=None, ori=0.0, 
...
text_6 = visual.TextStim(win=win, name='text_6',
    text='',
    font='Arial',
    pos=(0, 0), height=0.026, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-1.0);
...
for thisTrial_3 in trials_3:
    ...
    # keep track of which components have finished
    feedbackComponents = [cross_feed, s_left, s_right, s_if_left, s_if_right, text_2, text_5]
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if text_5.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > text_5.tStartRefresh + 0.8-frameTolerance:
                # keep track of stop time/frame for later
