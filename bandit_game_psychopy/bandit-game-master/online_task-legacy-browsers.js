...
function info_start1RoutineBegin(snapshot) {
  return async function () {
    ...
    info_start1Components.forEach( function(thisComponent) {
...
function info_stim1RoutineBegin(snapshot) {
  return async function () {
    ...
    info_stim1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function cuesRoutineBegin(snapshot) {
  return async function () {
    ...
    cuesComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function selection_animationRoutineBegin(snapshot) {
  return async function () {
    ...
    selection_animationComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function too_slowRoutineBegin(snapshot) {
  return async function () {
    ...
    too_slowComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function general_feedRoutineBegin(snapshot) {
  return async function () {
    ...
    general_feedComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
